...
export default function HeroSection() {
  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center bg-black scroll-mt-28">
      <canvas ref={canvasRef} className="absolute inset-0 w-full h-full" />
      <div className="container mx-auto px-4 text-center relative z-10">
        <h1 className="text-5xl md:text-6xl font-bold mb-4 text-white">VishwamAI</h1>
        ...
        <p className="text-xl md:text-2xl max-w-2xl mx-auto text-gray-300">
          Pioneering Agentic AI & Digital Fashion
        </p>
        <p className="text-lg md:text-xl max-w-3xl mx-auto mt-4 text-gray-400">
          Currently developing <span className="text-[#00BFFF] font-semibold">Design Wear</span> - A revolutionary platform for virtual fashion design and try-on
        </p>
      </div>
    </section>
  )
